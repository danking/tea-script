...
Goals for Monday
 ...
 - [ ] proper translation of `+' etc. to JS
 - [ ] Gensym to handle non-JS allowed variable names
 - [ ] Gensym variable names must align one to one to symbols of the same
       textual representation
 - [ ] complete support for the `letrec' form
 - [ ] complete support for the `cond' form
 - [ ] runtime tests (compile into JS and then run in a JS interpeter)
